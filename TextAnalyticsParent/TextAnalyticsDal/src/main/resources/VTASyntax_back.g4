...
exprBasic : term   # ExprBasicTerm
          ...
          | exprSpeakerTermsList # ExprTermsList
;

exprSpeakerTermsList: (customerTermsList | agentTermsList);
...
customerTermsList: CUSTOMER_IDENT ':' '(' (phrase|word)+ ')';
agentTermsList : AGENT_IDENT ':' '(' (phrase|word)+ ')';
